...
- **`nix.json`** - Nix-specific configuration with safe regex managers for `fetchPypi`-style updates only; `fetchFromGitHub` hashes are intentionally left for manual recomputation (see ADR-023)
